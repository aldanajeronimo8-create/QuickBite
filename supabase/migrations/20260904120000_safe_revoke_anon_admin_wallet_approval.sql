...
-- unnecessary public/anonymous EXECUTE exposure without changing the application flow.
REVOKE EXECUTE ON FUNCTION public.admin_approve_wallet_topup(uuid) FROM PUBLIC;
