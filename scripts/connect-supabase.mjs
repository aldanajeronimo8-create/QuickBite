...
async function main() {
  ...
  env.SUPABASE_DB_URL = await ask('SUPABASE_DB_URL opcional para aplicar migraciones', env.SUPABASE_DB_URL);
  env.SUPABASE_SERVICE_ROLE_KEY = await ask('SUPABASE_SERVICE_ROLE_KEY opcional para bootstrap server-side', env.SUPABASE_SERVICE_ROLE_KEY);
