...
export function AdminLayout() {
  ...
  // Solo se muestran las ventas que todavía no han sido exportadas.
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="w-full text-xs font-bold py-1.5 rounded-lg transition-opacity hover:opacity-90 disabled:opacity-50"
            style={{
              background: OK,
              color: '#052e16',
            }}
      ...
      >
        <DialogContent>
          ...
          <div className="space-y-3 text-sm text-slate-700">
            <p>
              ¿Deseas exportar las ventas actuales a Google Sheets
              y reiniciar la gestión de pagos?
            </p>

            <div className="rounded-lg bg-slate-50 p-3">
              <p>
                <b>{activeOrders.length}</b> venta(s) serán exportadas.
              </p>

              <p>
                <b>${activeTotal.toLocaleString()}</b> es el total
                del período.
              </p>
            </div>

            <p className="text-amber-800">
              Después del reinicio, estas ventas dejarán de aparecer
              en Gestión de Pagos. No se modificará nada si Google
              Sheets no confirma la recepción completa.
            </p>
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button
              disabled={
                exporting || activeOrders.length === 0
              }
