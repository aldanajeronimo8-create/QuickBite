...
const ParentFoodControlsPage = lazy(() => import('./pages/ParentFoodControlsPage').then((m) => ({ default: m.ParentFoodControlsPage })));
const ParentWellbeingPage = lazy(() => import('./pages/ParentWellbeingPage').then((m) => ({ default: m.ParentWellbeingPage })));
...
const AdminNutrition = lazy(() => import('./pages/admin/AdminNutrition').then((m) => ({ default: m.AdminNutrition })));
...
export const router = createBrowserRouter([
  { path: '/', element: <LoginPage /> }, { path: '/login', element: <LoginPage /> }, { path: '/register-student', element: lazyPage(AccountTypeChoicePage) }, { path: '/register-student/form', element: lazyPage(StudentRegisterPage) }, { path: '/register-parent', element: lazyPage(ParentRegisterPage) }, { path: '/parent/family', element: <RoleProtectedRoute role="parent">{lazyPage(ParentFamilyPage)}</RoleProtectedRoute> }, { path: '/parent/food-controls', element: <RoleProtectedRoute role="parent">{lazyPage(ParentFoodControlsPage)}</RoleProtectedRoute> }, { path: '/parent/wellbeing', element: <RoleProtectedRoute role="parent">{lazyPage(ParentWellbeingPage)}</RoleProtectedRoute> }, { path: '/verify-order', element: lazyPage(OrderVerificationPage) },
  { path: '/menu', element: <RoleProtectedRoute role="student"><StudentExperienceLayout /></RoleProtectedRoute> }, { path: '/student/features', element: <RoleProtectedRoute role="student"><StudentFeatureCenter /></RoleProtectedRoute> }, { path: '/student/reviews', element: <RoleProtectedRoute role="student">{lazyPage(StudentReviewsPage)}</RoleProtectedRoute> }, { path: '/student/order-windows', element: <RoleProtectedRoute role="student"><StudentOrderWindows /></RoleProtectedRoute> }, { path: '/student/account', element: <RoleProtectedRoute role="student"><StudentAccountPage /></RoleProtectedRoute> }, { path: '/student/wallet', element: <RoleProtectedRoute role="student"><StudentWalletPage /></RoleProtectedRoute> }, { path: '/student/history', element: <RoleProtectedRoute role="student"><StudentHistoryPage /></RoleProtectedRoute> }, { path: '/student/rewards', element: <RoleProtectedRoute role="student"><StudentRewardsPage /></RoleProtectedRoute> }, { path: '/student/favorites', element: <RoleProtectedRoute role="student"><StudentFavoritesPage /></RoleProtectedRoute> }, { path: '/student/link-code', element: <RoleProtectedRoute role="student"><StudentLinkCodePage /></RoleProtectedRoute> }, { path: '/student/notifications', element: <RoleProtectedRoute role="student"><StudentNotificationsPage /></RoleProtectedRoute> },
  ...
  { path: '/admin', element: <ProtectedRoute><AdminProtectedDataGate><AdminExperienceLayoutClean /></AdminProtectedDataGate></ProtectedRoute>, children: [ { index: true, element: lazyPage(AdminDashboard) }, { path: 'appearance', element: <AdminAppearance /> }, { path: 'features', element: lazyPage(QuickBiteFeatureCenter) }, { path: 'operations', element: lazyPage(AdminOperations) }, { path: 'rankings', element: lazyPage(AdminOperations) }, { path: 'reviews', element: lazyPage(AdminReviews) }, { path: 'orders', element: lazyPage(AdminOrders) }, { path: 'payments', element: lazyPage(AdminPayments) }, { path: 'wallet', element: lazyPage(AdminWalletTopups) }, { path: 'inventory', element: lazyPage(AdminInventory) }, { path: 'menu', element: lazyPage(AdminMenu) }, { path: 'nutrition', element: lazyPage(AdminNutrition) }, { path: 'verification', element: lazyPage(AdminVerification) }, { path: 'users', element: lazyPage(AdminUsers) }, { path: 'loyalty', element: lazyPage(AdminLoyalty) }, { path: 'reports', element: lazyPage(AdminReports) }, { path: 'history', element: lazyPage(AdminHistory) }, { path: 'system', element: lazyPage(AdminSystem) }, { path: 'reset', element: lazyPage(AdminResetPage) } ] },
