...
export const router = createBrowserRouter([
  { path: '/', element: <LoginPage /> }, { path: '/login', element: <LoginPage /> }, { path: '/register-student', element: lazyPage(AccountTypeChoicePage) }, { path: '/register-student/form', element: lazyPage(StudentRegisterPage) }, { path: '/register-parent', element: lazyPage(ParentRegisterPage) }, { path: '/parent/family', element: <RoleProtectedRoute role="parent">{lazyPage(ParentFamilyPage)}</RoleProtectedRoute> }, { path: '/parent/food-controls', element: <RoleProtectedRoute role="parent">{lazyPage(ParentFoodControlsPage)}</RoleProtectedRoute> }, { path: '/verify-order', element: lazyPage(OrderVerificationPage) },
