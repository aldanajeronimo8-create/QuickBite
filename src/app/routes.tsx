...
import { ParentStudentMenuPage } from './pages/student/ParentStudentMenuPage';
...
function StudentMenuRoute() {
  ...
  return activeStudent ? <ParentStudentMenuPage /> : <StudentExperienceLayout />;
}
