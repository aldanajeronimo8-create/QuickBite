    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600 text-lg">
          Escanea el código QR o ingresa el número de orden
        </p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-blue-50 border-l-4 border-blue-500 rounded">
              <p className="text-sm text-blue-800">
                💡 <strong>Tip:</strong> En un entorno real, aquí podrías usar la cámara
                para escanear el código QR del pedido.
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-8 bg-white shadow-2xl border-0 mt-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="flex justify-center">
              <div className="p-6 bg-white rounded-2xl shadow-lg border-4 border-green-600 flex flex-col items-center justify-center gap-3" style={{ width: 224, height: 224 }}>
                <svg viewBox="0 0 80 80" width="160" height="160" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {[32,36,40,44,48].map((x) => [32,36,40,44,48].map((y) => (
                    Math.sin(x * y) > 0 ? <rect key={`${x}-${y}`} x={x} y={y} width="3" height="3" fill="#111"/> : null
                  )))}
                ...
                <span className="text-xs font-mono font-bold text-gray-700 tracking-wider">{verifiedOrder.order_number}</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">
                  {format(
                    new Date(verifiedOrder.created_at),
              ...
              <div>
                ...
                <p className="font-medium text-gray-900 capitalize">
                  {verifiedOrder.payment_method === 'cash' ? 'Efectivo' : verifiedOrder.payment_method}
                </p>
              </div>
            </div>
          </div>
