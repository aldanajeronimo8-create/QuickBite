...
import { ChevronDown, ChevronUp, Download, Eye, EyeOff, Gift, ShoppingBag } from 'lucide-react';
...
export function AdminOrdersFixed() {
  ...
  const changeStatus = async (orderId: string, status: Order['status']) => {
    try { await updateOrder(orderId, { status }); toast.success('Estado del pedido actualizado'); }
