...
export function AdminSystem() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setActivity([
        { label: 'Persistencia', at: snapshot.persistence_last_activity_at ?? null },
        { label: 'Automatización', at: snapshot.automation_last_execution_at ?? null },
        { label: 'Auditoría', at: snapshot.audit_last_event_at ?? null },
      ]);
      setNow(Date.now());
    } catch (e) {
