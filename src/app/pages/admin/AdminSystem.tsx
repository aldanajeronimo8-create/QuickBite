...
export function AdminSystem() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setMetrics([
        { label: 'Eventos de auditoría', value: Number(snapshot.audit_events ?? 0) },
        { label: 'Alertas abiertas', value: Number(snapshot.open_alerts ?? 0) },
        { label: 'Jobs fallidos', value: Number(snapshot.failed_jobs ?? 0) },
        { label: 'Automatizaciones activas', value: Number(snapshot.active_automations ?? 0) },
      ]);
    } catch (e) {
