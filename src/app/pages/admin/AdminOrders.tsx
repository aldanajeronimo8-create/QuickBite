...
import { Check, ShoppingBag, X, XCircle } from 'lucide-react';
...
export function AdminOrders() {
  ...
  return <div>
    <div className="mb-8 flex flex-wrap items-start justify-between gap-4"><div><h1 className="mb-2 text-4xl font-bold text-green-800">Gestión de pedidos</h1><p className="text-lg text-gray-600">Aquí aparecen todos los pedidos con pago confirmado o rechazado. Los pagos pendientes se revisan en Pagos; los pedidos con pago confirmado pasan a esta cola operativa.</p></div><div className="flex flex-wrap gap-2"><Button type="button" variant="outline" className="border-red-300 text-red-700 hover:bg-red-50" onClick={() => window.location.assign('/admin/reset')}>Reiniciar período de prueba</Button></div></div>
