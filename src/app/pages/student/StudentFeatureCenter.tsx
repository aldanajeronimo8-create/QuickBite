  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(22,163,106,.14),_transparent_38%),radial-gradient(circle_at_top_right,_rgba(37,99,235,.12),_transparent_34%),#f5f8f7] p-5 text-slate-900 sm:p-8">
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link to="/student/account" className="rounded-3xl border border-white/60 bg-white/65 p-5 shadow-sm backdrop-blur-xl"><Wallet className="h-5 w-5 text-emerald-700"/><h2 className="mt-3 font-black">Mi cuenta</h2><p className="mt-1 text-sm text-slate-600">Saldo, alergias, restricciones y gestión familiar.</p></Link>
        ...
        <Link to="/student/account" className="rounded-3xl border border-white/60 bg-white/65 p-5 shadow-sm backdrop-blur-xl sm:col-span-2 lg:col-span-3"><div className="flex items-center gap-3"><ClipboardList className="h-5 w-5 text-emerald-700"/><ShoppingCart className="h-5 w-5 text-emerald-700"/><div><h2 className="font-black">Cuenta y compras</h2><p className="mt-1 text-sm text-slate-600">Administra tu billetera, preferencias alimentarias y relaciones familiares desde un solo lugar.</p></div></div></Link>
      </div>
    </div>
  </div>;
}
