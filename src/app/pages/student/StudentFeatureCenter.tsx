  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(22,163,106,.14),_transparent_38%),radial-gradient(circle_at_top_right,_rgba(37,99,235,.12),_transparent_34%),#f5f8f7] p-5 text-slate-900 sm:p-8">
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link to="/student/wallet" className="rounded-3xl border border-emerald-200 bg-emerald-50/70 p-5 shadow-sm backdrop-blur-xl ring-1 ring-emerald-100"><CreditCard className="h-5 w-5 text-emerald-700"/><h2 className="mt-3 font-black">Saldos y recargas</h2><p className="mt-1 text-sm text-slate-600">Saldo disponible, recargas, estados, rechazos, horas y movimientos detallados.</p></Link>
        <Link to="/student/favorites" className="rounded-3xl border border-white/60 bg-white/65 p-5 shadow-sm backdrop-blur-xl"><Heart className="h-5 w-5 text-rose-600"/><h2 className="mt-3 font-black">Mis favoritos</h2><p className="mt-1 text-sm text-slate-600">Tus alimentos guardados para volver a pedirlos.</p></Link>
        <Link to="/student/account" className="rounded-3xl border border-white/60 bg-white/65 p-5 shadow-sm backdrop-blur-xl"><Wallet className="h-5 w-5 text-emerald-700"/><h2 className="mt-3 font-black">Mi cuenta</h2><p className="mt-1 text-sm text-slate-600">Mis datos, contraseña y preferencias alimentarias.</p></Link>
        ...
        {loyaltyEnabled && <Link to="/student/rewards" className="rounded-3xl border border-white/60 bg-white/65 p-5 shadow-sm backdrop-blur-xl"><Star className="h-5 w-5 text-amber-500"/><h2 className="mt-3 font-black">Puntos y premios</h2><p className="mt-1 text-sm text-slate-600">Consulta y canjea tus recompensas disponibles.</p></Link>}
        <Link to="/student/notifications" className="rounded-3xl border border-white/60 bg-white/65 p-5 shadow-sm backdrop-blur-xl"><Bell className="h-5 w-5 text-violet-600"/><h2 className="mt-3 font-black">Notificaciones</h2><p className="mt-1 text-sm text-slate-600">Revisa avisos y cambios de tus pedidos y recargas.</p></Link>
