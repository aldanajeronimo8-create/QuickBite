...
export function StudentAccountFeaturesPage() {
  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(22,163,106,.12),_transparent_35%),#f5f8f7] p-5 text-slate-900 sm:p-8"><div className="mx-auto max-w-5xl space-y-6">
    ...
    <div><p className="text-xs font-black uppercase tracking-[.2em] text-emerald-700">QuickBite</p><h1 className="text-3xl font-black">Mi cuenta</h1><p className="mt-1 text-sm text-slate-600">Mis datos, contraseña, billetera, preferencias y pedidos de esta semana.</p></div>
